...
const resourcesCanonicalUrl = getCanonicalUrl("/resources");

const resourcesWebPageJsonLd = {
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "sehar and iftar timing guide",
    "fajr fasting start",
    "maghrib iftar timing",
    "ramadan dua references",
  ],
  alternates: getPageAlternates("/resources"),
  openGraph: {
    type: "website",
    siteName: SITE_NAME,
    locale: "en_US",
